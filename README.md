...
5. **возвращает ETH на Bitget** и сводит на мейн-аккаунт — круг замкнулся.

> ⚠️ **Всё по-настоящему — двигаются реальные деньги. Тест-режима нет.**
> Первый раз запускай на ОДНОМ кошельке с маленькой суммой.
...
> Для первого раза: оставь один кошелёк в `wallets.xlsx` и маленькую сумму.
